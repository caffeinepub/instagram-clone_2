...
import type { Comment as _Comment, ExternalBlob as _ExternalBlob, Post as _Post, Story as _Story, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async commentOnPost(arg0: Principal, arg1: Time, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.commentOnPost(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createPost(arg0: ExternalBlob, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getExplorePosts(arg0: bigint): Promise<Array<Post>> {
        if (this.processError) {
            try {
                const result = await this.actor.getExplorePosts(arg0);
    ...
    async getFollowedUsersStories(): Promise<Array<[Principal, Array<Story>]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFollowedUsersStories();
    ...
    async getUserFeed(): Promise<Array<Post>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserFeed();
                return from_candid_vec_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async likePost(arg0: Principal, arg1: Time): Promise<void> {
        if (this.processError) {
            try {
    ...
    async postStory(arg0: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.postStory(await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        content: await from_candid_ExternalBlob_n17(_uploadFile, _downloadFile, value.content),
        likes: value.likes,
...
async function from_candid_tuple_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [Principal, Array<_Story>]): Promise<[Principal, Array<Story>]> {
    return [
        value[0],
        await from_candid_vec_n20(_uploadFile, _downloadFile, value[1])
    ];
}
...
async function from_candid_vec_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[Principal, Array<_Story>]>): Promise<Array<[Principal, Array<Story>]>> {
